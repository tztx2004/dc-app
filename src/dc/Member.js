    ...
    return(
        <>
            ...
            <section className="membx">
                ...
                <input type="text" maxLength="20" placeholder="아이디를 입력하세요" value={userId} onChange={changeUserId}></input>
                {
                    // 에러일 경우 메시지 보여주기
                    ...
                    <div className="msg">
                        <small style={{color:"red",fontSize:"10px"}}>
                            사용자 아이디는 5글자 이상 문자 또는 숫자를 포함해야합니다!
                        </small>
                    </div>
                ...
                {/* 2.비밀번호 */}
                <label>비밀번호 : </label>
                <input type="password" maxLength="20" placeholder="비밀번호를 입력하세요" value={pwd} onChange={changePwd}></input>

                {
                    pwdError && 
                    <div className="msg">
                        <small style={{color:"red",fontSize:"10px"}}>
                            비밀번호는 8자 이상이어야하며 문자와 숫자를 각각 하나 이상 포함해야합니다.
                        </small>
                    </div>
                }
                {/* 3.이름 */}
